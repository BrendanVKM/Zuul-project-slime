 ...
 * @version 2021.02.23 + 2021.02.25 + 2021.02.26 + 2021.04.25
 */
public class Player {
    ...
    /**
     * Create the player default constructor
     */
    public Player() {
            ...
            if (this.getWeightCarrying() < this.MAX_WEIGHT) {
                if (pSW.equals("Veldora")) {
                    ...
                    vInt = 3;
                        ...
                        + this.aCurrentRoom.getItems().getItem(pSW).getWeight()) > this.MAX_WEIGHT)
                    vInt = 0;
