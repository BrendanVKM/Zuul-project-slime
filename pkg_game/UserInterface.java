...
public class UserInterface implements ActionListener
{
    ...
    public void enable( final boolean pOnOff )
    {
        ...
        if ( ! pOnOff ) { // disable
            ...
            this.aBCmdL.removeAll(); // panel won't react to entry
            this.aBCmdR.removeAll();
            this.aBDrct.removeAll();
        }
    } // enable(.)

    /**
     * know if the GUI is disabled or not
     * @return true if the GUI is disabled, false otherwise
     */
    public boolean isDisabled() { return this.aIsDisabled; } // isDisabled()
